...
# default McVersion
scoreboard players set #McVersionDefault fktool 12103
...
execute if score DataVersion fktool matches 4082.. run scoreboard players set McVersion fktool 12103
