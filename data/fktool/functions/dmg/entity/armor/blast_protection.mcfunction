...
execute store result score #helm fktool.dmg run data get storage fktool:dmg/main temp.Inventory[{Slot:103b}].tag.Enchantments[{id:"minecraft:blast_protection"}].lvl
execute store result score #chest fktool.dmg run data get storage fktool:dmg/main temp.Inventory[{Slot:102b}].tag.Enchantments[{id:"minecraft:blast_protection"}].lvl
execute store result score #legs fktool.dmg run data get storage fktool:dmg/main temp.Inventory[{Slot:101b}].tag.Enchantments[{id:"minecraft:blast_protection"}].lvl
execute store result score #boots fktool.dmg run data get storage fktool:dmg/main temp.Inventory[{Slot:100b}].tag.Enchantments[{id:"minecraft:blast_protection"}].lvl
