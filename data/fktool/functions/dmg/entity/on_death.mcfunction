...
# You can add death events by adding your function to the tag `#fktool:dmg/entity/on_death`.
...
# ```
# `tag: #fktool:dmg/entity/on_death`
# ```json
# {
#   "values": [
...
function #fktool:dmg/entity/on_death
execute if entity @s[type=player] run function fktool:dmg/entity/death_message
