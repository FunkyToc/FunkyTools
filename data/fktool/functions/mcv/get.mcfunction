...
execute if score DataVersion fktool matches 3219.. run scoreboard players set McVersion fktool 11903
...
execute if score DataVersion fktool matches -1 run scoreboard players set McVersion fktool 11903
