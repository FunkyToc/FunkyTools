...
# default McVersion
scoreboard players set #McVersionDefault fktool 12005
...
execute if score DataVersion fktool matches 3837.. run scoreboard players set McVersion fktool 12005
