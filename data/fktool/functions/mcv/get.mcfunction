...
execute if score DataVersion fktool matches 3579.. run scoreboard players set McVersion fktool 12002
...
execute if score DataVersion fktool matches -1 run scoreboard players set McVersion fktool 12002
